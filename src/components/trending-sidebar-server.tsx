// No incluimos "use client" ya que es un Server Component

import Link from "next/link";
import { Star, Users, ThumbsUp, MessageSquare } from "lucide-react";

// Esta versión del componente obtendría datos del servidor
// Por ahora usamos datos estáticos similares al componente original
export default async function TrendingSidebarServer() {
  // Datos de ejemplo para las tendencias (los mismos que en la versión cliente)
  const trendingPosts = [
    {
      id: 1,
